...
# Thư mục gốc chứa các thư mục con tên là tên khoa học
base_dir = r"D:\Homework\NC\original_images"  # ← chỉnh đường dẫn phù hợp

# Map từ nhãn Wikipedia → file
label_to_filename = {
    "Giới": "Gioi.txt",
    "Bộ": "Bo.txt",
    "Họ": "Ho.txt",
...
# Hàm chính để crawl phân loại khoa học
...
# === Chạy toàn bộ ===
def main():
    missing_data = []  # List để chứa tên cây không có thông tin taxonomy
    ...
    # Tạo DataFrame cho cây thiếu taxonomy
    if missing_data:
